...
```bash
# 配置 MCP
npx ccg-workflow-modify menu  # 选择「配置 MCP」
```

## 实用工具

```bash
npx ccg-workflow-modify menu  # 选择「实用工具」
```
...
```bash
npx ccg-workflow-modify menu  # 选择「安装 Claude Code」
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=fengshao1227/ccg-workflow-modify&type=timeline&legend=top-left)](https://www.star-history.com/#fengshao1227/ccg-workflow-modify&type=timeline&legend=top-left)
